...
# installed.
TK_PREFIX='/Volumes/DATA/project1/ndlinear_docai'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Volumes/DATA/project1/ndlinear_docai'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Volumes/DATA/project1/ndlinear_docai/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Volumes/DATA/project1/ndlinear_docai/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Volumes/DATA/project1/ndlinear_docai/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Volumes/DATA/project1/ndlinear_docai/lib/libtkstub8.6.a'
